...
namespace AssociationInput {
    ...
    public static class KeyboardGlobalHook {
        ...
        private static Dictionary<byte, KeySet> _convertMappingUser1 = new Dictionary<byte, KeySet> {
            ...
            { ScanCode.G, new KeySet(KeySetPair.Slash) },
        ...
        private static Dictionary<byte, KeySet> _convertMappingUser2 = new Dictionary<byte, KeySet> {
            ...
            { ScanCode.M, new KeySet(KeySetPair.PrintScreen) },
            { ScanCode.LessThan, new KeySet(KeySetPair.ScrollLock) },
            { ScanCode.GreaterThan, new KeySet(KeySetPair.Pause) },
            { ScanCode.Slash, new KeySet(KeySetPair.CapsLock) },
